...
lazy val frgFormatterSettings = Seq(
...
lazy val frgFormatterProject = Project(
  id = "fragnostic-formatter-project",
  base = file(".")).settings(
    frgFormatterSettings ++ Seq(
...
lazy val frgFormatter = Project(
  id = "fragnostic-formatter",
  base = file("fragnostic-formatter")).settings(frgFormatterSettings ++ Seq(
